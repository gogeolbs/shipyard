...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.provisioning'
        db.add_column(u'containers_container', 'provisioning',
                      self.gf('django.db.models.fields.TextField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.provisioning'
        db.delete_column(u'containers_container', 'provisioning')
    ...
    models = {
        ...
        u'containers.container': {
            ...
            'provisioning': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'})
        },
